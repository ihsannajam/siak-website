...
export const MODULE_CONFIGS: Record<string, ModuleConfig> = {
  ...
  grades: {
    ...
    columns: [
      { key: 'student', label: 'Siswa', accessor: 'student.fullName' },
      { key: 'subject', label: 'Mapel', accessor: 'subject.name' },
      { key: 'type', label: 'Jenis' },
      { key: 'score', label: 'Nilai' },
      { key: 'isLocked', label: 'Terkunci' },
    ],
    fields: [
      {
        name: 'studentId',
      ...
      },
      {
        ...
        type: 'select',
        required: true,
        optionsFrom: { path: '/semesters', labelKey: 'type' },
      },
      {
        name: 'type',
        label: 'Jenis Nilai',
      ...
      { name: 'score', label: 'Nilai (0-100)', type: 'number', required: true },
      { name: 'description', label: 'Keterangan', type: 'textarea' },
    ],
  },
  ...
  tahfidz: {
    ...
    columns: [
      ...
      { key: 'fromAyah', label: 'Dari Ayat' },
      { key: 'toAyah', label: 'Sampai Ayat' },
    ...
    fields: [
      ...
      { name: 'surah', label: 'Surah', required: true },
      { name: 'fromAyah', label: 'Dari Ayat', type: 'number', required: true },
      { name: 'toAyah', label: 'Sampai Ayat', type: 'number', required: true },
      {
        name: 'quality',
      ...
      { name: 'date', label: 'Tanggal', type: 'date', required: true },
      { name: 'teacherNote', label: 'Catatan Guru', type: 'textarea' },
    ],
  },
  ...
  mutabaah: {
    ...
    fields: [
      ...
      { name: 'date', label: 'Tanggal', type: 'date', required: true },
      { name: 'activity', label: 'Kegiatan (mis. Shalat Dhuha)', required: true },
      { name: 'value', label: 'Capaian / Nilai' },
  ...
  'attendance-students': {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Kelas',
        type: 'select',
        optionsFrom: { path: '/classes', labelKey: 'name' },
      },
      { name: 'date', label: 'Tanggal', type: 'date', required: true },
      {
        name: 'status',
      ...
      { name: 'note', label: 'Keterangan', type: 'textarea' },
    ],
  },
  ...
  'attendance-employees': {
    ...
    apiPath: '/attendance-employees',
    permissionKey: 'attendance-employees',
    columns: [
      { key: 'employee', label: 'Pegawai', accessor: 'employee.fullName' },
      { key: 'date', label: 'Tanggal' },
      { key: 'status', label: 'Status' },
      { key: 'note', label: 'Keterangan' },
    ],
